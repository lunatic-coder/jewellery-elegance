            ...
            <div>
              ...
              <div className="space-y-8 mb-12">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@elegancejewelry.com" className="text-primary hover:underline">
                      info@elegancejewelry.com
                    </a>
                    <p className="text-muted-foreground mb-1 mt-2">For customer support:</p>
                    <a href="mailto:support@elegancejewelry.com" className="text-primary hover:underline">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground mb-1">Corporate Headquarters:</p>
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <a href="#" className="p-2 bg-secondary rounded-full hover:bg-secondary/80">
            ...
            <div>
              ...
              {submitSuccess ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button 
                    type="submit" 
                    className="elegant-button-filled w-full"
